 ...
 * @copyright  Copyright (C) 2010-2011 Antonio J. García Lagar <aj@garcialagar.es>
 */
class Ajgl_Controller_Router_Route_ModuleQueryStringTest
    extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->route = new Ajgl_Controller_Router_Route_ModuleQueryString($defaults, $this->_dispatcher, $this->_request);
    }
