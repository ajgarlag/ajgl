 ...
 * @license    http://www.fsf.org/licensing/licenses/agpl-3.0.html AGPL3
 */
class Ajgl_Criteria_Criterion_WildcardTest
    extends PHPUnit_Framework_TestCase
{
    /**
     * @var Ajgl_Criteria_Criterion_Wildcard
     */
    protected $_criterion;
    
    public function setUp()
    {
        $this->_criterion = new Ajgl_Criteria_Criterion_Wildcard('foo', 'bar*');
    }
     ...
     * @expectedExceptionMessage Value must have at least one wildcard
     */
    public function testConstructorFailsIfNoWildcard()
    {
