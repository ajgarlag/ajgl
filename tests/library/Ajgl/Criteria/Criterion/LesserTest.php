 ...
 * @license    http://www.fsf.org/licensing/licenses/agpl-3.0.html AGPL3
 */
class Ajgl_Criteria_Criterion_LesserTest
    extends PHPUnit_Framework_TestCase
{
    /**
     * @var Ajgl_Criteria_Criterion_Lesser
     */
    protected $_criterion;
    
    public function setUp()
    {
        $this->_criterion = new Ajgl_Criteria_Criterion_Lesser('foo', 'bar');
    }
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals(
            Ajgl_Criteria_Criterion_FieldAbstract::OPERATOR_LESSER,
